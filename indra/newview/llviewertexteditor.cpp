	  ...
	  mInventoryCallback(new LLEmbeddedNotecardOpener)
{
	...
	// *TODO: Add right click menus for M7URLs
	// Build the right click menu
	// make the popup menu available

	//LLMenuGL* menu = LLUICtrlFactory::getInstance()->buildMenu("menu_m7url.xml", this);
	//if (!menu)
	//{
...
std::string LLViewerTextEditor::appendTime(bool prepend_newline)
{
	...
	if (gSavedSettings.getBOOL("VHAddSecondsInHistory"))
