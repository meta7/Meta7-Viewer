...
InstallDirRegKey HKEY_LOCAL_MACHINE "SOFTWARE\MMR\${INSTNAME}" ""
...
Function CheckIfAlreadyCurrent
  Push $0
	ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG" "Version"
...
DeleteRegKey HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG"
...
lbl_check_silent:
	...
	ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\MMR\${INSTNAME}" "InstallerLanguage"
...
lbl_build_menu:
	...
	WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\MMR\${INSTNAME}" "InstallerLanguage" $LANGUAGE
lbl_return:
    Pop $0
    Return
FunctionEnd
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Write registry
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG" "" "$INSTDIR"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG" "Version" "${VERSION_LONG}"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG" "Flags" "$INSTFLAGS"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG" "Shortcut" "$INSTSHORTCUT"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\MMR\$INSTPROG" "Exe" "$INSTEXE"
