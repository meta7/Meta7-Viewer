...
class ViewerManifest(LLManifest):
    def construct(self):
        ...
        self.path(src="../../release_notes.txt", dst="release_notes.txt")
...
class DarwinManifest(ViewerManifest):
    def construct(self):
        ...
        self.path(self.args['configuration'] + "/Meta7 Viewer.app", dst="")
        ...
        if self.prefix(src="", dst="Contents"):  # everything goes in Contents
            ...
            self.path("Info-Meta7.plist", dst="Info.plist")
	    ...
	    self.path("../../libraries/universal-darwin/lib_release/libiconv.2.dylib", "MacOS/libiconv.2.dylib");
            ...
            if self.prefix(src="", dst="Resources"):
                ...
                if self.default_channel() and self.default_grid():
                    self.path("Meta7_icon.icns")
                else:
                    self.path("Meta7_icon.icns", "Meta7_icon.icns")
                self.path("SecondLife.nib")
...
#                self.path("../mac_updater/" + self.args['configuration'] + "/mac-updater.app", "mac-updater.app")
        ...
        if ("package" in self.args['actions'] or 
            ...
            self.run_command('strip -S "%(viewer_binary)s"' %
                             { 'viewer_binary' : self.dst_path_of('Contents/MacOS/Meta7 Viewer')})
...
class LinuxManifest(ViewerManifest):
    ...
    def package_finish(self):
        if 'installer_name' in self.args:
            ...
            installer_name_components = ['Meta7_', self.args.get('arch')]
